...
export default function UserDashboardClient({ initialLogs, userName }: { initialLogs: AbsenLog[], userName: string }) {
  ...
  return (
    <div className="space-y-8 animate-in fade-in duration-500">
      <div>
        ...
        <p className="text-blue-600/80 mt-1 font-medium">Selamat datang kembali, {userName}.</p>
      </div>
